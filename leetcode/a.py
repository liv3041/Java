...
root=Tk()
root.title('Music player project by Moozic')
...
Button(root, image=Button_Play, bg="#0f1a2b", bd=0, command=Play_Music).place(x=100, y=500)
...
Label(root, image=Menu, bg="#0f1a2b").pack(padx=50, pady=500, side=RIGHT)
